...
{    
        ...
        String startDate, String endDate)
    {
        ...
        String query =
                ...
                +  "FROM v_User "
                +  "   INNER JOIN v_Download ON v_User.UserID = v_Download.UserID "
        ...
        String startDate, String endDate)
    {
        ...
        String query =
                ...
                +  "FROM v_Invoice "
                +  "   INNER JOIN v_LineItem ON v_Invoice.InvoiceID = v_LineItem.InvoiceID "
                +  "   INNER JOIN v_Product ON v_LineItem.ProductID = v_Product.ProductID "
            ...
            String startDate, String endDate)
    {
        ...
        String query =
                "SELECT InvoiceDate, v_Invoice.InvoiceID, "
                +    "v_User.UserID, EmailAddress, "
                +    "v_Product.ProductCode, ProductPrice, "
                +    "Quantity "
                +  "FROM v_User "
                +  "   INNER JOIN v_Invoice ON v_User.UserID = v_Invoice.UserID "
                +  "   INNER JOIN v_LineItem ON v_Invoice.InvoiceID = v_LineItem.InvoiceID "
                +  "   INNER JOIN v_Product ON v_LineItem.ProductID = v_Product.ProductID "
                +  "WHERE InvoiceDate >= '" + startDate + "' "
                +  "   AND InvoiceDate <= '" + endDate + "' "
